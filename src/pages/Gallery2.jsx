...
const Gallery2 = () => {
  ...
  // Form state with individual controlled inputs
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 space-y-4 md:space-y-0">
          ...
          >
            <h1 className="text-3xl font-bold text-gray-800">Gallery 2</h1>
            <p className="text-gray-600 mt-1">Enhanced media gallery with advanced features</p>
          </motion.div>
